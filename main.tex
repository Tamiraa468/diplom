...
\newcommand{\ttitle}{Байгууллагын бүтээгдэхүүн түгээлтийн нэгдсэн систем}
...
\newcommand{\keywordsMN}{B2B платформ, захиалгын удирдлага, бодит цагийн хяналт, React Native, Firebase, гар утасны аппликейшн, денормализаци}
\newcommand{\keywordnames}{B2B платформ, захиалгын удирдлага, бодит цагийн хяналт, React Native, Firebase, гар утасны аппликейшн, денормализаци}
...
\include{Chapters/DataLineageSystem}
